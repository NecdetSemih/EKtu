        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Instructor_Title_TitleId",
                        column: x => x.TitleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructorDepartment_Instructor_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Instructor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentChooseCourse", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentChooseCourse_Course_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentChooseCourse_Student_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorDepartment_InstructorId",
                table: "InstructorDepartment",
                column: "InstructorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentChooseCourse_CourseId",
                table: "StudentChooseCourse",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentChooseCourse_StudentId",
                table: "StudentChooseCourse",
                column: "StudentId");
        }
